...
| `gen_v5.py` | **v5 · 1단계** 아트보드 15종과 다크 짝 — 하루 시트 9종(시트 기본·목록 우선·수정·완료 카드·확인 4종·분류하기·이력 부족 히어로·360px·각주 조합) + 홈 달력 6종(접힘 스트립 · 펼침 월 달력 390/360 · 지난달 보기 · 칸 상태표 · 폭과 글자 크기). 펼침은 어느 폭에서도 7열 월 달력(계획 7판). 홈은 `Main.dc.html`을 잘라 쓴다 |
