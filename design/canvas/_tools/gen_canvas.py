...
WIDE = {'DesktopHome': (1440, 900), 'DesktopLedger': (1440, 900), 'DarkDesktopHome': (1440, 900),
        ...
        'DesktopHomeV5': (1440, 1000), 'DarkDesktopHomeV5': (1440, 1000),   # v5 달력이 들어간 데스크톱 홈(제안)
...
NOTES = {
    ...
    'page-4': ('note-desktop', 640,
               ...
               '셋째 장은 v5 달력이 들어간 데스크톱 홈 제안입니다 — 달력을 어디 둘지는 계획에 결정이 없어, 히어로 아래 왼쪽 열 첫 자리에 7열 월 달력을 펼친 채로 두는 안을 그렸습니다. 한도 라벨은 v5 · 3단계의 「앞으로 하루 47,270원」이고, 사이드바는 v4 · 2단계 뒤 모습입니다 — 목표 · 미래 대신 「목적지」 하나이고, 주식을 켠 사용자 기준이라 「주식」 칸이 있는 5칸입니다(주식을 끄면 4칸). 데스크톱의 달력 자리는 계획에 결정이 없어 제안으로 둡니다.\n\n'
    ...
    'page-11': ('note-v5-stage1', 640,
               'v5 · 1 · 2단계 — 홈 달력과 하루 시트 (plan/v5-calendar.md 9판)\n\n'
               ...
               '→ 오늘 칸을 눌렀을 때(오늘과 기록 없는 날은 입력 우선 — 금액에 자동 포커스 · 키보드 자리는 빈 판, 그날 기록은 키보드 아래 「오늘 기록」 · 셋째 줄 첫 장) → 저장 뒤 완료 카드(날짜 · 정확 금액 · 오늘 합계, 소비율 변화는 예상 기준이 확인된 달에만, 취소는 방금 기록한 건만). '
    ...
    'page-13': ('note-v5-elsewhere', 640,
               ...
               '첫째 줄: 소비 · 내역 — 필터 칩 「분류 안 함 7건」, 날짜 머리글의 「소비 · 이체」 합계(달력 칸과 같은 값)와 확인한 날 ✓, 행의 ⋯ 메뉴 「매달 반복으로 만들기」 · 월 마감 — 새 체크박스 문구와 「분류 안 함 4건 · 32,000원이 기타로 들어가요 · 지금 분류 ›」(마감을 막지 않음) · '
    ...
    'page-14': ('note-v5-stage3', 640,
               ...
               '셋째 장: 소비 · 한도 화면의 기타 아래 「분류 안 함 4건 32,000원」 서브라인, 기타 한도 경고와 코치의 최대 카테고리 비중을 미확정 금액을 빼고 다시 판정했다는 한 줄, 코치 「소비 기록이 필요합니다」 본문의 「소비 없음 확인 n일」 병기. '
