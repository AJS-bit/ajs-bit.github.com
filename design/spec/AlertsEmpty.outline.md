...
원본 `canvas/AlertsEmpty.dc.html`. 값이 다르면 **원본이 맞습니다.**
  ...
  - `div` **BottomSheet**
    ...
    - `div`
      ...
      - `div`
        ...
        - `div`
          `width:40px height:40px border-radius:13px background:#E4F4EA display:flex align-items:center justify-content:center`
        - `div` **text 13.5px/600** — “지금 조치할 것이 없어요”
          `font-size:13.5px font-weight:600 color:#101828 margin-top:10px`
        - `div` **text 12px/400** — “한도·부채·비상금 모두 정상 범위입니다”
