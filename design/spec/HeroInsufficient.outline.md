# HeroInsufficient — 블록 개요

원본 `canvas/HeroInsufficient.dc.html`. 값이 다르면 **원본이 맞습니다.**
  ...
  - `div` **본문(스크롤 영역)**
    ...
    - `div` **Card(18)**
      ...
      - `div`
        ...
        - `div`
          `position:absolute inset:0 99.8% 0 0 border-radius:99px background:linear-gradient(90deg, #6E6BEE 0%, #7A3FE4 100%)`
  - `div` **BottomNav**
