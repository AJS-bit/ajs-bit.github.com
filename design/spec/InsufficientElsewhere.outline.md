...
- `div`
  `width:1230px height:1330px background:#EDF0F7 color:#101828 padding:28px 30px 30px display:flex flex-direction:column gap:10px`
  ...
  - `h2` **text 20px/700** — “예상 기준을 확인하기 전 — 홈 밖의 화면들”
    `font-size:20px font-weight:700 letter-spacing:-0.025em color:#101828`
  - `p` **text 13px/400** — “홈의 이력 부족 상태(HeroInsufficient)와 같은 사람입니다 — 9월 5일에 처음 열었고 오늘 커피 5,”
  ...
  - `div` **Card(18)**
    ...
    - `div`
      ...
      - `div` — “소비 · 이번 달 — 숫자 옆 배지 ‘ ’ · ‘ ’가 없습니다. 예상 값(소비율 · 월말 예상)은 공식대로 계산해”
    ...
    - `div`
      ...
      - `span` **text 10.5px/700** — “2”
        `margin-top:1px width:17px height:17px border-radius:99px background:#101828 color:#FFFFFF font-size:10.5px font-weight:700 display:inline-flex align-items:center justify-content:center box-shadow:0 0 0 2px #FFFFFF`
      - `div` — “그 자리에 사실 문구 ‘ ’ 한 줄만 남습니다. 색 · 아이콘으로 좋다 · 나쁘다를 말하지 않습니다.”
        `font-size:12px line-height:1.55 color:#475467`
    ...
    - `div`
      ...
      - `span` **text 10.5px/700** — “3”
        `margin-top:1px width:17px height:17px border-radius:99px background:#101828 color:#FFFFFF font-size:10.5px font-weight:700 display:inline-flex align-items:center justify-content:center box-shadow:0 0 0 2px #FFFFFF`
      - `div` — “한도 탭 — 예상에서 나오는 한도 각주와 카테고리 줄의 ‘ ’이 없습니다. 이미 넘은 한도는 예상이 아니라 사실이므”
        `font-size:12px line-height:1.55 color:#475467`
        - `b` — “초과 예상”
          `font-weight:600 color:#101828`
    - `div`
      ...
      - `span` **text 10.5px/700** — “4”
        `margin-top:1px width:17px height:17px border-radius:99px background:#101828 color:#FFFFFF font-size:10.5px font-weight:700 display:inline-flex align-items:center justify-content:center box-shadow:0 0 0 2px #FFFFFF`
      - `div` — “코치 — ‘ ’ · ‘ ’가 없습니다. 고금리 부채처럼 확정된 안내는 그대로입니다.”
        `font-size:12px line-height:1.55 color:#475467`
        - `b` — “예상 잔여자금률 77% — 축적 여력이 큽니다”
          `font-weight:600 color:#101828`
        - `b` — “모든 목표가 궤도에 있습니다”
          `font-weight:600 color:#101828`
    - `div`
      ...
      - `span` **text 10.5px/700** — “5”
        `margin-top:1px width:17px height:17px border-radius:99px background:#101828 color:#FFFFFF font-size:10.5px font-weight:700 display:inline-flex align-items:center justify-content:center box-shadow:0 0 0 2px #FFFFFF`
      - `div` — “다음 안내 — ‘ ’가 없습니다. 홈(HeroInsufficient)과 같은 카드입니다.”
        `font-size:12px line-height:1.55 color:#475467`
        - `b` — “지금의 저축·투자 흐름을 유지하세요”
          `font-weight:600 color:#101828`
    - `div`
      `display:flex gap:10px padding:7px 0 border-bottom:1px solid #F3F5FA`
      - `span` **text 10.5px/700** — “6”
        `margin-top:1px width:17px height:17px border-radius:99px background:#101828 color:#FFFFFF font-size:10.5px font-weight:700 display:inline-flex align-items:center justify-content:center box-shadow:0 0 0 2px #FFFFFF`
      - `div` — “또래 카드 — ‘ ’ 줄이 없습니다. 나머지(연령 구간 · 기준 등록)는 그대로입니다.”
        `font-size:12px line-height:1.55 color:#475467`
        - `b` — “목표 60% 안에서 순항 중”
          `font-weight:600 color:#101828`
    - `div`
      ...
      - `span` **text 10.5px/700** — “7”
        `margin-top:1px width:17px height:17px border-radius:99px background:#101828 color:#FFFFFF font-size:10.5px font-weight:700 display:inline-flex align-items:center justify-content:center box-shadow:0 0 0 2px #FFFFFF`
      - `div` — “알림 — 예상으로 만든 ‘ ’는 목록과 개수(제목 · 머리줄 종 배지)에서 모두 빠집니다. 알림 생성은 그대로 두고”
        `font-size:12px line-height:1.55 color:#475467`
        - `b` — “이번 달 적자입니다”
          `font-weight:600 color:#101828`
    - `div` — “판정은 하나입니다 — 예상 기준 확인 규칙(계획 §3-4)을 통과하기 전이면 위 일곱 곳이 전부 이 모양이고, 통과”
