...
원본 `canvas/TourGoals2.dc.html`. 값이 다르면 **원본이 맞습니다.**
...
- `div` **화면프레임**
  ...
  - `div`
    ...
    - `div` **HeroCard**
      `position:absolute left:14px top:302px width:362px height:380px border-radius:20px box-shadow:0 0 0 2px rgba(255,255,255,.95), 0 0 0 4px #3556E6, 0 0 0 9999px rgba(16,24,40,.62)`
    - `div` **Card(18)**
      `position:absolute left:14px width:362px bottom:554px background:#FFFFFF border:1px solid #E3E8F1 border-radius:18px padding:16px display:flex flex-direction:column gap:8px box-shadow:0 12px 32px -12px rgba(16,24,40,.45)`
      - `div`
